...
export default async function TermsOfUsePage() {
  ...
  try {
    document = await apiFetch<LegalDocument>("/v1/legal/documents/current?type=TERMS_OF_USE");
  } catch (err) {
    error = err instanceof ApiError ? err.message : "Não foi possível carregar os termos de uso agora.";
  }
