...
/** Reproduz o padrão real de export do AZ: bloco de cabeçalho de relatório antes da tabela de dados. */
...
describe('client-import-parser', () => {
  ...
  describe('analyzeClientSpreadsheet', () => {
    it('classifies rows as IMPORTAVEL, PARCIAL, DUPLICADO and NAO_IMPORTAVEL correctly', () => {
      ...
      expect(analysis.rows).toHaveLength(5);

      const [importavel, parcialSemEmail, semContato, semNome, duplicado] = analysis.rows;
